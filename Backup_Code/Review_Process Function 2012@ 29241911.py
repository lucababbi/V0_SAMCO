        ...
        if TopPercentage.tail(1).select("Full_MCAP_USD_Cutoff_Company").to_numpy()[0][0] < Lower_GMSR:
            ...
            while Companies_To_Delete <= Maximum_Deletion:
                ...
                if len(TopPercentage.head(len(TopPercentage) - Companies_To_Delete)) > 1:
                    ...
                    # In case the threshold is not reached, just removed what is possible
            ...
            # Update the Lower GMSR?
            Lower_GMSR = TopPercentage.head(len(TopPercentage) - Companies_To_Delete).tail(1).select("Full_MCAP_USD_Cutoff_Company").to_numpy()[0][0]
