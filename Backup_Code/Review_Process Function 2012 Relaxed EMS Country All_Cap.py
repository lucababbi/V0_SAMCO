...
# MSCI GMSR Mar_2012
GMSR_Upper_Buffer = 0.994
GMSR_Lower_Buffer = 0.997
# GMSR_Upper_Buffer = 0.9925
# GMSR_Lower_Buffer = 0.9950
...
Standard_Index_Output_Code = pl.read_csv(r"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\Standard\Standard_Index_Security_Level_Shadows_0.85_True_20241101_CN_Reduced.csv").with_columns(
...
def Turnover_Check(Frame: pl.DataFrame, Pivot_TOR: pl.DataFrame, Threshold_NEW, Threshold_OLD, date, Starting_Date, Screened_Securities) -> pl.DataFrame:
    ...
    for Row in Frame.iter_rows(named=True):
        ...
        # Check for IPO/New Addition to the Index
        if any(math.isnan(value) for value in TOR_Values) and not math.isnan(TOR_Values[-1]):
            # Keep only the non N_A values
            TOR_Values = [value for value in TOR_Values if not math.isnan(value)]
...
# Store the Results
Standard_Index.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\All_Country\AllCap_Index_Security_Level_{Percentage}_ETF_Version_Coverage_Adjustment_{Coverage_Adjustment}_" + current_datetime + "_Extened_GMSR.csv")
Recap_Count_Standard.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\All_Country\Recap_Count_AllCap_{Percentage}_ETF_Version_Coverage_Adjustment_{Coverage_Adjustment}_" + current_datetime + "_Extened_GMSR.csv")
Recap_Weight_Standard.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\All_Country\Recap_Weight_AllCap_{Percentage}_ETF_Version_Coverage_Adjustment_{Coverage_Adjustment}_" + current_datetime + "_Extened_GMSR.csv")
GMSR_Frame.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\All_Country\GMSR_Frame_{Percentage}_ETF_Version_Coverage_Adjustment_{Coverage_Adjustment}_" + current_datetime + "_Extened_GMSR.csv")
EMS_Frame.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\All_Country\EMS_Frame_{Percentage}_ETF_Version_Coverage_Adjustment_{Coverage_Adjustment}_" + current_datetime + "_Extened_GMSR.csv")
