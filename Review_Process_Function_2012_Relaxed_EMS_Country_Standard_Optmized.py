...
# AllCap Index Output
AllCapIndexOutput = pl.read_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\Tests\AllCap_Index_Security_Level_{GMSR_Upper_Buffer_AllCap}_{GMSR_Lower_Buffer_AllCap}_" + current_datetime + ".csv").select(
...
# Store the Results
Standard_Index.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\Tests\Standard_Index_Security_Level_CNTarget_{CN_Target_Percentage}_" + current_datetime + ".csv")
Standard_Index_Shadows.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\Tests\Standard_Index_Security_Level_Shadows_CNTarget_{CN_Target_Percentage}_" + current_datetime + ".csv")
