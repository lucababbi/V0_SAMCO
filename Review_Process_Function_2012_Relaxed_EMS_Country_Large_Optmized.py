...
# MSCI GMSR Mar_2012
GMSR_Upper_Buffer = 0.70
GMSR_Lower_Buffer = 0.72
GMSR_Percentage = 0.70
GMSR_MSCI = np.float64(10_307 * 1_000_000)
...
# Store the Results
Standard_Index.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V0_SAMCO\Output\Tests\Large_Index_Security_Level_CNTarget_{CN_Target_Percentage}_" + current_datetime + ".csv")
